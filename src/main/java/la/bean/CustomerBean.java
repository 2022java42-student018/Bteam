...
public CustomerBean(int cID,String cName, String cAddress, String cTell, String cMail, Date cBday) {
...
public CustomerBean(String cName, String cAddress, String cTell, String cMail, Date cBday,Date cJdate) {
